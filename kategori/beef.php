<?php
  $data = file_get_contents('https://www.themealdb.com/api/json/v1/1/filter.php?c=Beef');
  $beef = json_decode($data, true);
...
<html lang="en">
  <head>
    ...
    <title>Wilayah Dapur | Kategori : Beef</title>
  </head>
  <body>
    ...
    <div class="container">
    	<div class="row mt-3 mb-3 pt-2">
    		<div class="col judul text-center" data-aos="zoom-in-down" data-aos-duration="2000">
    			<h1><i>Kategori : Beef</i></h1>
    		</div>
    	</div>
    	<div class="row justify-content-evenly">
    		<?php foreach ($beef as $row) : ?>
