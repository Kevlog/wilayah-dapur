<?php
  $data = file_get_contents('https://www.themealdb.com/api/json/v1/1/filter.php?c=Lamb');
  $lamb = json_decode($data, true);
...
<html lang="en">
  <head>
    ...
    <title>Wilayah Dapur | Kategori : Lamb</title>
  </head>
  <body>
    ...
    <div class="container">
    	<div class="row mt-3 mb-3 pt-2" data-aos="zoom-in-down" data-aos-duration="2000">
    		<div class="col judul text-center">
    			<h1><i>Kategori : Lamb</i></h1>
    		</div>
    	</div>
    	<div class="row justify-content-evenly">
    		<?php foreach ($lamb as $row) : ?>
