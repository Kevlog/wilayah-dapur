<?php
  $data = file_get_contents('https://www.themealdb.com/api/json/v1/1/filter.php?c=Side');
  $side = json_decode($data, true);
...
<html lang="en">
  <head>
    ...
    <title>Wilayah Dapur | Kategori : Side</title>
  </head>
  <body>
