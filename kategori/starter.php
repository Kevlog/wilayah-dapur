<?php
  $data = file_get_contents('https://www.themealdb.com/api/json/v1/1/filter.php?c=Starter');
  $starter = json_decode($data, true);

  //var_dump($category["categories"][0]["strCategory"]);

  $starter = $starter["meals"];
...
<html lang="en">
  <head>
    ...
    <title>Wilayah Dapur | Kategori : Starter</title>
  </head>
  <body>
